...
export function AgentOverview() {
  ...
  return (
    <GlassPanel level={2} className="p-4">
      <h3 className="display mb-3 flex items-center gap-1.5 text-sm font-semibold">
        ...
        {agents.map((a) => {
          ...
          return (
            <button
              ...
              className="card-lift flex flex-col gap-2 rounded-hud border border-outline-variant bg-surface-lowest p-3 text-left"
